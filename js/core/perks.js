...
export const PERKS = [
  ...
  { id: 'velocity', name: { ko: '고속 파동', en: 'VELOCITY' }, desc: { ko: '파동 속도 +25%', en: 'Wave speed +25%' },
    apply: (r) => { r.waveMul *= 1.25; } },
  { id: 'harvest', name: { ko: '채굴 강화', en: 'HARVEST' }, desc: { ko: '크리스탈 에너지 +60%', en: 'Crystal energy +60%' },
    apply: (r) => { r.crystalMul *= 1.6; } },
