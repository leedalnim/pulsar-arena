...
const DICT = {
  ko: {
    ...
    soundEffects: '효과음',
    screenShake: '화면 흔들림',
    local2p: '로컬 2인 (P2: 방향키)',
    p2Hint: 'P2 (로컬 2인): 방향키 이동 · Enter 설치 · / 대시 · \' 실드 · . 코어전환',
    opponentBots: '상대 봇',
    matchLength: '매치 시간',
    on: '켜짐',
    off: '꺼짐',
  ...
  en: {
    ...
    local2p: 'Local 2-Player (P2: arrows)',
    p2Hint: 'P2 (local 2P): Arrows move · Enter deploy · / dash · \' shield · . cycle',
